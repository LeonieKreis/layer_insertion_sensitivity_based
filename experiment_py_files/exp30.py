...
lr_init = 1e-1
optimizer_type = 'SGD'
lrscheduler_type_class = 'StepLR'
lrscheduler_type = 'MultiStepLR'

lrscheduler_args1 = {'step_size': [[40],[30,40,40,40]],
                    'gamma': 0.1}

lrscheduler_args2 = {'step_size': [[40],[20,40,40,40]],
                    'gamma': 0.1}

lrscheduler_args3 = {'step_size': [[40],[10,40,40,40]],
                    'gamma': 0.1}

lrscheduler_args4 = {'step_size': [[40],[40,40,40,40]],
                    'gamma': 0.1}

lrscheduler_args5 = {'step_size': [[40,40],[30,40,40]],
                    'gamma': 0.1}

lrscheduler_args6 = {'step_size': [[40,40],[20,40,40]],
                    'gamma': 0.1}

lrscheduler_args7 = {'step_size': [[40,40],[10,40,40]],
                    'gamma': 0.1}

lrscheduler_args8 = {'step_size': [[40,40],[40,40,40]],
                    'gamma': 0.1}
...
lrscheduler_args_classical = {'step_size': 40,  #T9 T10
                              'gamma': 0.1}
...
for i in range(no_of_initializations):
    ...
    if T1:
        model1, mb_losses1, test_errors_short1, test_errors1, exit_flag1, grad_norm1 = layer_insertion_loop(
            ...
            lrscheduler_args=lrscheduler_args1,
    ...
    if T2:
        model2, mb_losses2, test_errors_short2, test_errors2, exit_flag2, grad_norm2 = layer_insertion_loop(
            ...
            optimizer_type=optimizer_type,
            lrschedule_type=lrscheduler_type,
            lrscheduler_args=lrscheduler_args2,
            check_testerror_between=interval_testerror,
            decrease_after_li=lr_decrease_after_li,
            print_param_flag=False,
            start_with_backtracking=None,
    ...
    if T3:
        model2, mb_losses2, test_errors_short2, test_errors2, exit_flag2, grad_norm2 = layer_insertion_loop(
            ...
            optimizer_type=optimizer_type,
            lrschedule_type=lrscheduler_type,
            lrscheduler_args=lrscheduler_args3,
            check_testerror_between=interval_testerror,
            decrease_after_li=lr_decrease_after_li,
            print_param_flag=False,
            start_with_backtracking=None,
    ...
    if T4:
        model2, mb_losses2, test_errors_short2, test_errors2, exit_flag2, grad_norm2 = layer_insertion_loop(
            ...
            optimizer_type=optimizer_type,
            lrschedule_type=lrscheduler_type,
            lrscheduler_args=lrscheduler_args4,
            check_testerror_between=interval_testerror,
            decrease_after_li=lr_decrease_after_li,
            print_param_flag=False,
            start_with_backtracking=None,
    ...
    if T5:
        model2, mb_losses2, test_errors_short2, test_errors2, exit_flag2, grad_norm2 = layer_insertion_loop(
            ...
            optimizer_type=optimizer_type,
            lrschedule_type=lrscheduler_type,
            lrscheduler_args=lrscheduler_args5,
            check_testerror_between=interval_testerror,
            decrease_after_li=lr_decrease_after_li,
            print_param_flag=False,
            start_with_backtracking=None,
    ...
    if T6:
        model2, mb_losses2, test_errors_short2, test_errors2, exit_flag2, grad_norm2 = layer_insertion_loop(
            ...
            optimizer_type=optimizer_type,
            lrschedule_type=lrscheduler_type,
            lrscheduler_args=lrscheduler_args6,
            check_testerror_between=interval_testerror,
            decrease_after_li=lr_decrease_after_li,
            print_param_flag=False,
            start_with_backtracking=None,
    ...
    if T7:
        model2, mb_losses2, test_errors_short2, test_errors2, exit_flag2, grad_norm2 = layer_insertion_loop(
            ...
            optimizer_type=optimizer_type,
            lrschedule_type=lrscheduler_type,
            lrscheduler_args=lrscheduler_args7,
            check_testerror_between=interval_testerror,
            decrease_after_li=lr_decrease_after_li,
            print_param_flag=False,
            start_with_backtracking=None,
    ...
    if T8:
        model2, mb_losses2, test_errors_short2, test_errors2, exit_flag2, grad_norm2 = layer_insertion_loop(
            ...
            optimizer_type=optimizer_type,
            lrschedule_type=lrscheduler_type,
            lrscheduler_args=lrscheduler_args8,
            check_testerror_between=interval_testerror,
            decrease_after_li=lr_decrease_after_li,
            print_param_flag=False,
            start_with_backtracking=None,
