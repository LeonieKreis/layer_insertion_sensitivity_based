...
lrscheduler_args = {'step_size': [40,200],
                    'gamma': 0.1}
...
lrscheduler_args_classical = {'step_size': [40,200],
                              'gamma': 0.1}
...
no_of_initializations = 10 #30  # 50
...
for i in range(no_of_initializations):
    ...
    if lrscheduler_type == 'MultiStepLR':
        step_size = lrscheduler_args_classical['step_size']
        gamma = lrscheduler_args_classical['gamma']
        lrscheduler_classical = torch.optim.lr_scheduler.MultiStepLR(
            optimizer_classical, milestones=step_size, gamma=gamma)
