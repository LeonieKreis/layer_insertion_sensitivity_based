...
batch_size = 60000  # 60000 for full batch
...
fix_width_classical = [50,15,15,15,15]
...
for i in range(no_of_initializations):
    ...
    if T3:
        ...
        mblosses_classical, lr_end, test_error_classical, exit_flag3 = train(model_classical,
                                                                 train_dataloader=train_dataloader,
