...
for i in range(no_of_initializations):
    ...
    mb_losses0, lr_end0, test_error_classical0, exit_flag0, grad_norm0, times0 = train(model_classical,
                                                                 train_dataloader=td,
    ...
    write_losses(f'results_data_spirals/Exp{k}_0.json', mb_losses0, max_length, structures=[
                    epochs_classical], errors=test_error_classical0,
                    interval_testerror=interval_testerror, times=times0, grad_norms = grad_norm0,
