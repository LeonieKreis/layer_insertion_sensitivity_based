...
from spirals_data_new import gen_spiral_dataset, plot_dataset, plot_decision_boundary
...
kwargs_net_classical2 = {
    ...
    'dim_hidden_layers': 2*fix_width_classical, # fix_width_classical+[fix_width_classical[-1]],
    'act_fun': act_fun,
    'type': _type
}
...
# build net for classical big
    ...
    if optimizer_type == 'Adam':
        optimizer_classical2 = torch.optim.Adam(
            model_classical2.parameters(), lr_init_classical)
