...
k = 264 # mb whento insert with 3 different seeds
...
fix_width = [10,10]
no_iters = 1
lr_decrease_after_li = 1 # in exp8 was 0.8
epochs_beforeLI = 50
epochs_afterLI = 1000  
epochs = [epochs_beforeLI, epochs_afterLI]
...
for i in range(no_of_initializations):
    ...
    if T1:
        ...
        epochs[0]=epochs[0]+epoch_diff
        epochs[1]=epochs[1]-epoch_diff
    ...
    if T9:
        ...
        # save losses3
        write_losses(f'results_data_spirals/Exp{k}_9.json', mblosses_classical, max_length, structures=[
...
# build net for classical big
    ...
    if optimizer_type == 'SGD':
        optimizer_classical2 = torch.optim.SGD(
            model_classical2.parameters(), lr_init_classical*lr_decrease_after_li)
    ...
    if T10:
        ...
        # save losses3
        write_losses(f'results_data_spirals/Exp{k}_10.json', mblosses_classical2, max_length, structures=[
