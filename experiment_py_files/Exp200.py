...
for i in range(no_of_initializations):
    ...
    if T1:
        ...
        write_losses(path1,
                     ...
                     grad_norms = None, its_per_epoch=no_steps_per_epoch)
    ...
    if T2:
        ...
        # iniitialize model with the same parameters as the first model
    ...
    if T5:
        ...
        if _type == 'res2':
            model_init5 = two_weight_resnet(dim_in, dim_out, **kwargs_net)
        if _type == 'res1':
            model_init5 = one_weight_resnet(dim_in, dim_out, **kwargs_net)
